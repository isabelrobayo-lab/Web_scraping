...
- Use the async engine (asyncpg) for running migrations
- Read DATABASE_URL from app settings (not from alembic.ini)
- Support autogenerate from SQLAlchemy models
...
async def run_async_migrations() -> None:
    ...
    Creates an async engine from the configuration, connects, and
    runs migrations within the connection context.
    """
